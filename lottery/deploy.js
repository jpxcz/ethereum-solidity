...
const provider = new HDWalletProvider(
  'day magnet sponsor indicate top cram ankle pause quick energy glow prepare', // account mnemonic
...
deploy()
day magnet sponsor indicate top cram ankle pause quick energy glow prepare
